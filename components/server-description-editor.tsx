...
export function ServerDescriptionEditor({ document, disabled, serverId, onChange, onMessage, onUploadPoster, posterUrl }: Props) {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: { class: "full-description-content", role: "textbox", spellcheck: "true", "aria-label": "서버 상세 소개 편집", "aria-multiline": "true" },
